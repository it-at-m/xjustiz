    ...
    protected Object createCodeGDSClass(XoevCodeGDS codeGDS, String codelistValueKey) {
        ...
        switch (codeGDS) {
            ...
            case CODE_GDS_DOKUMENTKLASSE:
                ...
                dokumentklasse.setCode(xjustizProperty.getCodelisten().get(XoevCodeGDS.CODE_GDS_DOKUMENTKLASSE.getDescriptor()).currentCodelistValueWithKey(codelistValueKey));
            ...
            case CODE_GDS_BESTANDTEILTYP:
                ...
                bestandteiltyp.setCode(xjustizProperty.getCodelisten().get(XoevCodeGDS.CODE_GDS_BESTANDTEILTYP.getDescriptor()).currentCodelistValueWithKey(codelistValueKey));
            ...
            case CODE_GDS_AKTENZEICHENART:
                ...
                aktenzeichenart.setCode(xjustizProperty.getCodelisten().get(XoevCodeGDS.CODE_GDS_AKTENZEICHENART.getDescriptor()).currentCodelistValueWithKey(codelistValueKey));
            ...
            case CODE_GDS_REGISTERZEICHEN:
                ...
                registerzeichen.setCode(xjustizProperty.getCodelisten().get(XoevCodeGDS.CODE_GDS_REGISTERZEICHEN.getDescriptor()).currentCodelistValueWithKey(codelistValueKey));
