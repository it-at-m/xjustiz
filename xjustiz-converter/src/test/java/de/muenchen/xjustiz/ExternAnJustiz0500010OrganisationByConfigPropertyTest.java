...
public class ExternAnJustiz0500010OrganisationByConfigPropertyTest extends ExternAnJustiz0500010TestEnvironment {
    ...
    public void init() throws Exception {
        ...
        Exchange request = ExchangeBuilder.anExchange(camelContext).withBody(new ContentContainer(createFachdaten(), new GrunddatenContent( new ArrayList<>(List.of(createPersonSubjectToCoerceiveDetention()))))).build();
